...
func (w Walking) Calories() float64 {
	...
	speedMs := w.Training.meanSpeed() * KmHInMsec
	return ((CaloriesWeightMultiplier*w.Training.Weight + (math.Pow(speedMs, 2))/(w.Height/CmInM)*CaloriesSpeedHeightMultiplier*w.Training.Weight) * w.Training.Duration.Hours() * MinInHours)
}
